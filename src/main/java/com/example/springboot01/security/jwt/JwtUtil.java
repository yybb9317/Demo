...
public class JwtUtil {
    ...
    public static JwtUser parseJWT(String token) {
        ...
        try {
            ...
            String id = decode.getSubject();
            String username = decode.getClaim(CLAIM_UN).asString();
            String password = decode.getClaim(CLAIM_PW).asString();
